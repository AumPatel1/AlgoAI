...
const sidebarItems = [
  ...
  { icon: Hash, label: "Phone Numbers", href: "/dashboard/phone-numbers" },
  { icon: Mic, label: "Voices", href: "/dashboard/voices" },
  { icon: Brain, label: "Knowledge Bases", href: "/dashboard/knowledge" },
  { icon: MessageSquare, label: "SMS", href: "/dashboard/sms" },
  { icon: Globe, label: "Web Widget", href: "/dashboard/widget" },
